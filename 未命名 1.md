...
\end{align}
$$
$$f(k+3)\longrightarrow F(z)z^{3}-f(0)z^3-f(1)z^{2}-f(2)z^{3}$$$$f(k+2)\longrightarrow F(z)z^{2}-f(0)z^2-f(1)z$$$$f(k+1)\longrightarrow F(z)z-f(0)z$$$$f(k-1)\longrightarrow F(z)z^{-1}+f(-1)$$$$f(k-2)\longrightarrow F(z)z^{-2}+f(-1)z^{-1}+f(-2)$$$$f(k-3)\longrightarrow F(z)z^{-3}+f(-1)z^{-2}+f(-2)z^{-1}+f(-3)$$
