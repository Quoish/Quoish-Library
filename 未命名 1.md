...
$$f(k+3)=F(z)z^{3}-f(0)z^3-f(1)z^{2}-f(2)z^{3}$$$$f(k+2)=F(z)z^{2}-f(0)z^2-f(1)z$$$$f(k+1)=F(z)z-f(0)z$$$$f(k-1)=F(z)z^{-1}+f(-1)$$$$f(k-2)=F(z)z^{-2}+f(-1)z^{-1}+f(-2)$$$$f(k-3)=F(z)z^{-3}+f(-1)z^{-2}+f(-2)z^{-1}+f(-3)$$
$$f^{(-3)}(t)=F(s)s^{-3}+f^{(-1)}(0_{-})s^{-3}+f^{(-2)}(0_{-})s^{-2}+f^{(-3)}(0_{-})s^{-1}$$$$f^{(-2)}(t)=F(s)s^{-2}+f^{(-1)}(0_{-})s^{-2}+f^{(-2)}(0_{-})s^{-1}$$$$f^{(-1)}(t)=F(s)s^{-1}+f^{(-1)}(0_{-})s^{-1}$$$$f^{(1)}(t)=F(s)s-F(0_{-})$$$$f^{(2)}(t)=F(s)s^2-f(0_{-})s-f^{(1)}(0_{-})$$$$f^{(3)}(t)=F(s)s^3-f(0_{-})s^2-f^{(1)}(0_{-})s-f^{(2)}(0_{-})$$
