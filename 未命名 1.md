...
$\alpha=(x_{1},x_{2},x_{3},x_{4}),\beta=(y_{1},y_{2},y_{3},y_{4})$
$$\langle \vec{r}|\vec{p} \rangle =(2\pi \hbar)^{-3/2}e^{ i\vec{p}\cdot \vec{r}/\hbar }$$$$\langle \vec{r}|\vec{r}' \rangle =\delta(\vec{r}-\vec{r}')$$
