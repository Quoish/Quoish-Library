...
$$f(k-1)=F(z)z^{-1}+f(-1)$$$$f(k-2)=F(z)z^{-2}+f(-1)z^{-1}+f(-2)$$$$f(k-3)=F(z)z^{-3}+f(-3)z^{-2}+f(-2)z^{-1}+f(-1)$$
$$f^{(1)}(t)=sF(s)-F(0)$$$$f^{(2)}(t)=s^2F(s)-sf(0_{-})-f^{(1)}(0_{-})$$$$f^{(3)}(t)=s^3F(s)-s^2f(0_{-})-sf^{(1)}(0_{-})-f^{(2)}(0_{-})$$
