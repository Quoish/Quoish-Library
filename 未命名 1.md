...
\end{align}
$$
$$\left( \frac{ \partial  ^2 }{ \partial  x^2} -2\frac{ \partial  ^2 }{ \partial  x\partial y} +\frac{ \partial  ^2 }{ \partial  y^2} +\frac{ \partial   }{ \partial  x} -\frac{ \partial   }{ \partial  y}  \right)z=0$$$$x^2-2xy+y^2+x-y=0$$
