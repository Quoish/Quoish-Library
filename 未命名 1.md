...
$$x(t)=\sum_{n=-\infty}^{\infty} \frac{\sin\left( \frac{n}{2} \right)\cos(2n)}{\pi n}r\left( t-\frac{n}{8} \right)$$
$$H_{2}(j\omega)=\begin{equation}
\left\{
\begin{aligned}
&2,&|\omega|\leq 8\\
&0,&|\omega|>8
\end{aligned}
\right.
\end{equation}$$$$\langle \vec{r}|\vec{r}' \rangle =\delta(\vec{r}-\vec{r})$$
$$T_{1} \frac{\sqrt{ 2 }}{2}+T_{2} \frac{1}{2}=m\omega^2 L \frac{\sqrt{ 2 }}{2}$$

$$T_{1}=\frac{\sqrt{2 }}{2}mg,T_{2} =0,\implies mg=m\omega^2 L \frac{\sqrt{ 2 }}{2}\implies \sqrt{ 2 }gL=\omega^2$$
$$T_{1}=0,T_{2} =\frac{2}{\sqrt{ 3 }}mg,\implies \frac{1}{\sqrt{ 3 }}mg=m\omega^2 L \frac{\sqrt{ 2 }}{2}\implies \frac{\sqrt{ 2 }}{\sqrt{ 3  }}gL=\omega^2$$
