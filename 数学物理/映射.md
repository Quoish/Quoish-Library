...
## 运算律
### 结合律
>已知$X$上的封闭运算$\cdot$，若$$\forall x,y,z \in X,(x\cdot y)\cdot z=x\cdot(y\cdot z)$$则称$\cdot$有结合律（Associative Law）。

结合律赋予我们对一串$X$中元素作$\cdot$运算时不写括号的权利。
### 交换律
>已知$X$上的封闭运算$\cdot$，若$$\forall x,y \in X,x\cdot y=y\cdot x$$则称$\cdot$有交换律（Commutative Law）。

交换律赋予我们对一串$X$中元素作$\cdot$运算时忽略运算顺序的权利。
### 单位律
>已知$X$上的封闭运算$\cdot$，若$$\exists e \in X,\mathrm{s.t.}\forall x\in X,x\cdot e=e\cdot x=x$$则称$X$有关于$\cdot$的单位元（Identity）$e$。

- 单位元是唯一的。
### 零律
>已知$X$上的封闭运算$\cdot$，若$$\exists o \in X,\mathrm{s.t.}\forall x\in X,x\cdot o=o\cdot x=o$$则称$X$有关于$\cdot$的零元（Zero）$o$。

### 分配律
>已知$X$上的封闭运算$+,\cdot$，若$$\forall x,y,z \in X,\quad x\cdot(y+z)=x\cdot y+x\cdot z$$则称$\cdot$对$+$有左分配律（Left-Distributive Property）。$$\forall x,y,z \in X,\quad (y+z)\cdot x=y\cdot x+z\cdot x$$则称$\cdot$对$+$有右分配律（Right-Distributive Property）。
>同时满足两种分配律称满足分配律。

### 消去律
>已知$X$和$Y$到$Z$上的封闭运算$\cdot$，若$$\forall x \in X,y,z \in Y,\quad x\cdot y=x\cdot z\Longleftrightarrow y=z$$则称$\cdot$有左消去律（Left-Cancellation Property）。$$\forall x \in X,y,z \in Y,\quad y\cdot x=z\cdot x\Longleftrightarrow y=z$$则称$\cdot$有右消去律（Left-Cancellation Property）。
>同时满足两种分配律称满足消去律。