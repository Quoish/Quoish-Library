...
设$M,M'$是两个微分流形，有映射$f:M\to M'$，$p \in M$和$f(p)\in M'$的邻域$O_{\alpha},O_{\beta}'$分别于$\mathbb{R}^n,\mathbb{R}^{n'}$同胚，$(O_{\alpha},\psi_{\alpha}),(O_{\beta},\psi_{\beta})$为二者的坐标卡，，则$\psi_{\beta}\circ f\psi_{\alpha}^{-1}$是从$\mathbb{R}^n$到$\mathbb{R}^{n'}$的映射，
![[微分流形之间映射的可微性.png]]